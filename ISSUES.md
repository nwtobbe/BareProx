...
| #14 | Backup fails due to snapshots taking to long	| none									| **in progress**								|
| #13 | Backup failes due to auth-failuer				| none									| **Fixed**										|
| #12 | Fails on orphan disks							| Remove the disk						| **Fixed**										|
| #11 | Multiple netapp controllers cause confusion     | None									| **Fixed in 1.0.2511.0513**					|
| #10 | Retention daily is not keeping correct retention| None									| **Rejected, working**							|
