...
namespace BareProx.Migrations
{
    ...
    [Migration("20250528060805_AddSnapMirrorRelations")]
    partial class AddSnapMirrorRelations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BareProx.Models.SnapMirrorRelation", b =>
                {
                    ...
                    b.HasIndex("DestinationControllerId");

                    b.HasIndex("SourceControllerId");
            ...
            modelBuilder.Entity("BareProx.Models.SnapMirrorRelation", b =>
                {
                    b.HasOne("BareProx.Models.NetappController", "DestinationController")
                        .WithMany()
                        .HasForeignKey("DestinationControllerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BareProx.Models.NetappController", "SourceController")
                        .WithMany()
                        .HasForeignKey("SourceControllerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("DestinationController");

                    b.Navigation("SourceController");
                });
